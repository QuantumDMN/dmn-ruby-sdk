...
# Unit tests for Quantumdmn::Project
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Quantumdmn::Project do
  #let(:instance) { Quantumdmn::Project.new }

  describe 'test an instance of Project' do
    it 'should create an instance of Project' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Quantumdmn::Project)
    end
  end
